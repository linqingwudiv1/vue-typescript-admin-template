...
*/
export const constantRoutes: RouteConfig[] = constantRouter;

/**
 * 开发者模块
 */
export const developRoutes: RouteConfig[] = developRouter;

/**
 * 末尾静态 Router
 */
export const footerRoute:RouteConfig[] = footerRouter;
